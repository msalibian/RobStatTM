...
#  This program computes the   M-estimator  proposed  by Bianco and Yohai for 
#  logistic regression. By default, an intercept term is included 
#  and p parameters are estimated. 
#  Modified by Yohai (2018)  to take as initial estimator  a   weighted ML estimator  with weights derived from the MCD estimator
